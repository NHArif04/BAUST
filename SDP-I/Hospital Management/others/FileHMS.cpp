...
#include <cstdlib> // Added for password masking
...
int main()
{
    ...
    while (true)
    {
        ...
        case 2:
            ...
            { // Only proceed to the main menu if login is successful
                getchar();
                while (true)
                {
                    clearScreen();
...
/**
** heading, text same size font
** Hatei likhte hobe->lab report(ki ki hobe na hobe setar bekkha)
** slide(simple+point+no need extra design)
*/